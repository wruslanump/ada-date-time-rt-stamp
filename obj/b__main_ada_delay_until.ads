...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_delay_until" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b5e9263d#;
   pragma Export (C, u00001, "main_ada_delay_untilB");
