...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_date_time_rt_stamp" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fc32598a#;
   pragma Export (C, u00001, "main_ada_date_time_rt_stampB");
