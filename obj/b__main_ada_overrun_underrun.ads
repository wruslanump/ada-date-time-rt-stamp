...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_overrun_underrun" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c4124e32#;
   pragma Export (C, u00001, "main_ada_overrun_underrunB");
